...
The Paper Team will be publishing [breaking changes to the Shaders library](https://github.com/paper-design/shaders?tab=readme-ov-file#getting-started) under 0.0.x versioning so check back to get updates when they release Paper Shaders v1