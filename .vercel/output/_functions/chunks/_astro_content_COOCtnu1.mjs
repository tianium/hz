import { A as AstroError, R as RenderUndefinedEntryError, c as createComponent, u as unescapeHTML, d as renderTemplate, U as UnknownContentCollectionError, i as escape, j as renderUniqueStylesheet, k as renderScriptElement, l as createHeadAndContent, e as renderComponent } from './astro/server_DIDd5bfF.mjs';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_CuzzfZkq.mjs');
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_Y6DhjGcT.mjs').then(n => n._);
